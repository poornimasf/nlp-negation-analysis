...
- Enforces utils directory sync
- Runs in .git/hooks

The pre-commit hook will:
1. Check if you're in detached HEAD state
2. Verify you're on main branch
3. Ensure changes to utils files are synced between:
   - /main/src/utils/
   - /main/negation-analyzer/src/utils/

If sync check fails, you'll see:
```
❌ Error: file.js must also be synced to corresponding location
💡 Run: cp src/utils/file.js negation-analyzer/src/utils/
   Then: git add negation-analyzer/src/utils/file.js
```
